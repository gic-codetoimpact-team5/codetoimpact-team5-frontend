...
import Dropzone from 'components/main/ingestor/Dropzone';
  ...
  const handleFileUpload = async (files) => {
    try {
      ...
      for (const file of files) {
        ...
        console.log(`File ${file.name} uploaded to S3.`);
      }

      // Handle any additional logic after file upload, e.g., update state or trigger the next step.
    } catch (error) {
              ...
              <Dropzone
                ...
                content={
                  <Box>
                    ...
                    >
                      CSV and Excel files are allowed
                    </Text>
                  </Box>
                }
              />
